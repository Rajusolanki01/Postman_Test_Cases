...
2) Renamed the collection from Impledge_QA_Exercise to Impledge_QA_Raju_Solanki.
...
5) And added two test cases for this new request(Fetching shipment test case 1 & 2 ) 1st case was to Verify selected_rate.retail_rate is equal to 12 and 2nd case was to Verify retail_rate is greater than list_rate
6) And now make all changes to insure the test case passed 
